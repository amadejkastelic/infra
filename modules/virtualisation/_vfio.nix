# Plain NixOS module defining the `virtualisation.vfio` options. Imported
# relatively by modules/virtualisation/default.nix (the `_`-prefix keeps
# import-tree from auto-loading it as a flake-parts module).
# Replaces lib/vfio.nix.
{
  lib,
  config,
  ...
